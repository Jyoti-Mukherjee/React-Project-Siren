                    ...
                    {fooddata.filter((item) => item.id >=46 && item.id < 61).map((item, index) => {
                        return (
                            <div key={index} className="underdivtwofood">
                                ...
                                <img className="underdivimagetwofood" src={item.image} alt="error"/>
                                <NavLink className='navlinktwo' to={`/details/${item.id}` }><p className="underdivparatwofood" >{item.para.slice(0, 105)}... <span>{index +1}</span></p> </NavLink>
...
<div className="location">  <img className="logoonefood" src="https://tse2.mm.bing.net/th?id=OIP.jI9rruGSAQNGmMicjyVJFAHaI7&pid=Api&P=0&h=180" alt="Not Found"/></div> <span className="locfood">Kolkata, West Bengal</span>




<img className="logoonephonefood" src="https://tse2.mm.bing.net/th?id=OIP.MT6QS99KpW4roKRd3i1G7QHaHa&pid=Api&P=0&h=180" alt="Not Found"/><span className="phofood">2209866544</span>

<img className="logoonemailfood" src="https://cdn5.vectorstock.com/i/1000x1000/12/04/mail-icon-in-flat-style-email-symbol-in-flat-style-vector-28061204.jpg" alt="Not Found"/><span className="emailfood">jyo95.mukh@gmail.com</span>
