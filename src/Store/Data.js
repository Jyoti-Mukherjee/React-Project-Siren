...
const[data,setdata]=useState([
    ...
    //  head:'Adipurush To Ghoomer: Major Bollywood Flops Of 2023 So Far',
     ...
     para:'Pathaan is a 2023 Indian Hindi-language action thriller film directed by Siddharth Anand and written by Shridhar Raghavan',
...

 {
    ...
    para:'In misty Rudrakund, the brutal murder of a school student pushes troubled teacher ',
 ...
 },
{
    ...
    para:'Khufiya is a 2023 Hindi-language spy thriller film written, produced and directed by Vishal Bhardwaj..',
...

{
    ...
    para:'Gadar 2 (transl. Rebellion 2; subtitled onscreen with The Katha Continues) is a 2023 Indian Hindi-language.',
...
},
{
    ...
    para:'Aspirants is an Indian Hindi-language coming-of-age web series produced by .',
...
},
{
    ...
    para:'The Family Man is an Indian Hindi-language spy thriller streaming television series created by ',
...
},
{
    ...
    para:"Asur is an Indian Hindi-language psychological crime thriller streaming television series..",
  ...
  },
{
    ...
    para:"Sacred Games began development after Netflix vice-president Erik Barmack asked Motwane in 2014..",
},

{
    ...
    para:'Kota Factory is an Indian Hindi-language streaming television series created by Saurabh Khanna..',
...
},
{
    ...
    para:'Back from the brink of death, highly skilled commando Tyler Rake takes on another dangerous mission..',
...
},
{
    ...
    para:'Raging Bull is a 1980 biographical sports drama film directed by Martin Scorsese123..',
...
},
{
    ...
    para:'An intelligence operative for a shadowy global peacekeeping agency races to stop a hacker weapon..',
...
},
{
    ...
    para:'Andrew Garfield returns as Peter Parker, a teenager embracing his role as superhero..',
...
},
{
    ...
    para:'Rebel Without a Cause is a 1955 American coming-of-age romantic drama film about emotionally confused suburban..',
...
},
{
    ...
    para:"Citizen Kane is a 1941 American drama film directed by, produced by..",    
},
{
    id:26,
    ...
    para:'Game of Thrones is an American fantasy drama television series created by David Benioff and D. B. Weiss for HBO.',
...
},
{
    ...
    para:'Jurassic World is a 2015 American science fiction action film directed by Colin Trevorrow',
},
{
id:28,
name:'Toy Story',
...
para:'Toy Story is a 1995 American animated comedy film produced..',
...
//Fitness
{
    ...
    para:'This unique product can tone your back muscles, reduce belly fat..',
},
{
    id:32,
    ...
    para:'The “fat-burning zone” recommendations on commercial cardio equipment ',
},
{
 id:33,
 name:'Hand Gripper',
...
},
{
  ...
  para:'RESISTANCE BAND THAT ARE EASY TO USE : Made from latex.',
...
},
{
   ...
   para:'ANTI BURST & SLOW DEFLATION - Our exercise ball is made with the fine structure which makes it deflate slowly and burst resistant if punctured..',
...
},
{
    ...
    para:'Jumping rope requires very simple equipment: a jump rope, good shoes, and an impact-reducing surface. Most jump ropes cost under US$10 and can be found in sporting goods and many general merchandise stores. Jumping rope is a relatively high-impact fitness activity..',
...
},
{
    ...
    para:'The most common type of weightlifting gloves. They may provide more stability and support to the wrists and reduce calluses..',
},
{
id:38,
...
para:'Although there are many different forms of exercises for the roller wheel, the resistance of the band as well as the number of repetitions are the main variables used to..',
},
{
    id:39,
    name:'Fitness Ball',
    ...
    para:'An exercise ball is a ball constructed of soft elastic, typically in 5 diameters of 10 cm..',
},
{
  id:40,
  name:'Swimming',
  ...
  para:'Swimming is the self-propulsion of a person through water, or other liquid, usually for recreation..',
},
{
    id:41,
    name:'Miles Per Hour ',
    ...
    para:'On the other hand, power walking too slowly might only net you 100 calories or less for 30 minutes.',
    error:"page is not found"
...
para:'Exercise daily for at least an hour. You do not have to kill yourself from running, jogging, etc., but you should have some sort of moderate physical activity in your everyday life..',
error:"page is not found"
...
},
{
    ...
    para:'No matter how bad your stomach is telling you to go for candy over healthy food, try to stay away from sweets.',
    error:"page is not found"
...
},
{
    ...
    para:'Keeping track of how many calories you eat in a day will be helpful in planning out your physical exercising.',
    error:"page is not found"
...
},
{
    ...
    para:'An important key to being in shape is to set goals and keep a positive mindset. If you stay positive..',
    error:"page is not found"
...
//Food
{
    ...
    para:'It will make your mouth swim to eat Yorkshire Lamb Patties, a delectable delicacy. Your weekend celebrations will be enjoyable as a result..',
},
{
    id:47,
    name:'Prawn Pie',
    ...
    para:'The creamy, delectable snack is known as “prawn pie.” The cheese-topped leek mash gives it the ideal amount of coziness..',
},
{
    id:48,
    name:'Crispy Rings',
    ...
    para:'The most popular seafood in the entire globe is crispy calamari rings. Anyone can cook this tasty snack because it is simple to do so..',
},
{
   id:49,
   ...
   para:'The cheesy, spicy, and deliciousness of stuffed jacket potatoes. It is consumed as a robust lunch or a light meal..',
},
{
   id:50,
   name:'Pizza',
   ...
   para:'Pizza is a dish of Italian origin consisting of a usually round..',
},
{
   id:51,
   name:'Lamb Salad',
   ...
   para:'Wintertime is the perfect time to enjoy a warm, nutritious salad like roast lamb..',
...
},
{
  ...
  para:'Noodles are a type of food made from unleavened dough which is either rolled flat and cut..',
},
{
  id:53,
  name:'Butter Chicken',
  ...
  para:'A dish of tender chicken in a mildly spiced tomato sauce. It’s traditionally cooked in a tandoor (a cylindrical clay oven). The gravy is always made first by boiling down fresh tomato, garlic, and cardamom into a bright red pulp. This pulp is then pureed after cooling. Butter, various spices...',
...
},
{
   ...
   para:'The traditional southern Indian dish known as masala dosa is popular throughout the country, made from a batter of soaked rice and black lentils, which are ground into a paste and blended to',
...
},
{
    ...
    para:'A salad topping is placed on crispy potato cakes. On Sundays, everyone will enjoy cooking this sluggish brunch. You can have this dish with arugula & radicchio salad.',
},
{
    id:57,
    name:'Dal Makhani',
    ...
    para:'Although it originated in Punjab, dal makhani has become a favorite Indian lentil dish all over the country. It consists of black beans or red kidney beans and whole black lentils, called ‘urad’',
...
//Technology
{
   ...
   para:"In 2012, DTDC acquired a 52 percent stake in Eurostar Express of Eurostar Group in the UAE.",
...
},
{
    ...
    para:'The latest evolutionary software and features in HP Products to better your experience..',
},
{
    id:65,
    ...
    category:'Technology',
    para:'Global food production will need to increase by 70% by 2050 to feed a growing world population, according to the United Nations Food and Agriculture Organization.',
...
},
{
    ...
    para:'Soon, testing for disease could be as simple for patients as exhaling. New breath sensors can diagnose diseases',
},
{
    id:67,
    ...
    para:'The Internet of Things (IoT) is comprised of billions of electronic devices leveraging Internet connectivity for some aspect of their functionality..',
...
},
{
    ...
    para:'The Sustainable Development Goals (SDGs, or Global Goals), unanimously adopted at the United Nations in 2015.',
},

{
    ...
    para:'In telecommunications, 5G is the fifth-generation technology standard for cellular networks.',
...
// },
{
    ...
    para:'Robotics integrates many fields that deal with specific aspects of robotics..',
},
{
    id:73,
...
},
{
    ...
    para:'Wind power is the use of wind energy to generate useful work..',
...
},
{
    ...
    para:'An aircraft in flight is free to rotate in three dimensions. ',
